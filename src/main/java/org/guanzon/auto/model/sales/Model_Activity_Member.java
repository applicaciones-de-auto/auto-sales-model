 ...
 * @author Arsiela
 */
public class Model_Activity_Member implements GEntity {
     ...
     */
    public Model_Activity_Member(GRider foValue) {
        if (foValue == null) {
     ...
     * @return result as success/failed
     */
    public JSONObject setOriginal(String fsValue) {
        return setValue("cOriginal", fsValue);
    }
    ...
    public String getOriginal() {
        return (String) getValue("cOriginal");
    }
